/*TMODJS:{"version":1,"md5":"b9f83283085dc6776244f9625f11a72d"}*/
...
$out+='</textarea> </div> <div class="cell-content-img"> <input type="file" class="btn_file cell_img_hide"> <input class="btn_change_pic" type="button" onclick="$(this).siblings(\'.btn_file\').trigger(\'click\');" value="图片"> ';
...
$out+=' </div> </div> </div> <div class="col-sm-1"> ';
include('./Struct-Cell-Action');
